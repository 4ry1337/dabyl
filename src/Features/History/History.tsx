                ...
                <div className={'col-span-3'}>
                    <div className={'flex flex-col h-full'}>
                        ...
                        <div className={'relative grow'}>
                            ...
                            {result.isSuccess && <HistoryList list={result.data}/>}
                        </div>
                    </div>
                </div>
                <div className={'col-start-4'}>
                    <div className={'flex flex-row justify-center py-2.5 items-center space-x-4 leading-6'}>
                    ...
                    <div>
                        <Calendar
                            value={date}
                            setValue={setDate}
                            className={'block w-full p-6 bg-white border border-gray-200 rounded shadow'}
                            titleClassName={'leading-6 text-xl'}
                            buttonClassName={'mx-auto flex h-8 w-8 items-center justify-center rounded-full text-gray-300'}
                    ...
                    <div className={'flex flex-col justify-center mt-2.5'}>
                        <button
                            className={'bg-green hover:bg-darkGreen mx-auto text-white py-2.5 px-10 rounded-lg'}
